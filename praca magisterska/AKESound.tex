...
In our prototype microphone receives signal as a sinus wave. Because of this that we need to know the frequency of this signal we have to use some transform which turn sinus wave into the frequency spectrum. The solution is to use \textit{Fourier transform}.
...
\lstset{language=JAVA,caption={Method converting characters on sinus waves.}}
\begin{lstlisting}
